function TW_corrected = T_W_climb_calc_2(aircraft, W_S)
% Description: 
...
T_W = (aircraft.mission.climb.CD0(2) + ( CL^2/(pi*aircraft.geometry.wing.AR*aircraft.mission.climb.e(2))))/CL + aircraft.mission.climb.G(2);
