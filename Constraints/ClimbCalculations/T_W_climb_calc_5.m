function TW_corrected = T_W_climb_calc_5(aircraft, W_S)
% Description: 
...
T_W = (aircraft.mission.climb.CD0(5) + ( CL^2/(pi*aircraft.geometry.wing.AR*aircraft.mission.climb.e(5))))/CL + aircraft.mission.climb.G(5);
