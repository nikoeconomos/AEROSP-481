...
CL_max_TO = aircraft.aerodynamics.CL_takeoff_flaps; %This was from Cinar to use - estimated from similar aircraft with plain flaps and will be updated once we choose flaps to use
CD0_TO = aircraft.aerodynamics.CD0_takeoff_flaps_gear;
