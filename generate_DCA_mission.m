...
DCA_mission.cruise_out.flight_velocity = velocity_from_flight_cond(DCA_mission.cruisse_out.mach,DCA_mission.cruisse_out.t_amb,r_air); % [m/s]
...
DCA_mission.loiter.flight_velocity = velocity_from_flight_cond(DCA_mission.loiter.mach,DCA_mission.loiter.t_amb,r_air); % [m/s]
...
DCA_mission.dash.flight_velocity = velocity_from_flight_cond(DCA_mission.dash.mach,DCA_mission.dash.t_amb,r_air); % [m/s]
...
DCA_mission.combat1.flight_velocity = velocity_from_flight_cond(DCA_mission.combat1.mach,DCA_mission.combat1.t_amb,r_air); % [m/s]
...
DCA_mission.combat2.flight_velocity = velocity_from_flight_cond(DCA_mission.combat2.mach,DCA_mission.combat2.t_amb,r_air); % [m/s]
...
DCA_mission.cruise_in.flight_velocity = velocity_from_flight_cond(DCA_mission.cruise_in.mach,DCA_mission.cruise_in.t_amb,r_air); % [m/s]
...
DCA_mission.reserve.flight_velocity = velocity_from_flight_cond(DCA_mission.reserve.mach,DCA_mission.reserve.t_amb,r_air); % [m/s]
