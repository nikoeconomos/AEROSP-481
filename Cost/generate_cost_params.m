...
% Missile cost
aircraft.cost_params.missile_cost_base = 386000;  % USD
aircraft.cost_params.missile_cost_2024 = apply_inflation(aircraft.cost_params.missile_cost_base, base_year, target_year);

% Avionics cost 
aircraft.cost_params.avionics_cost_base = 234000;  % USD
aircraft.cost_params.avionics_cost_2024 = apply_inflation(aircraft.cost_params.avionics_cost_base, base_year, target_year);

% Cannon cost
aircraft.cost_params.cannon_cost_base = 250290;  % USD
aircraft.cost_params.cannon_cost_2024 = apply_inflation(aircraft.cost_params.cannon_cost_base, base_year, target_year);
