...
drum = 300;
engine = 4398.247;
one = aircraft.weights.TOGW; % empty weight
two = aircraft.weights.fuel_weight; %fuel weight 
three = 161.5; % [kg] payload 1 weight 
four = 161.5; % [kg] payload 2 weight
five = 161.5; % [kg] playload 3 weight 
six = 290; % [kg] cannon rounds
