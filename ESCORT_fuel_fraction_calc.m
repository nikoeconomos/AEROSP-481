...
% & 44. They are defined in the generate_ESCORT_mission function where all
% relevant parameters are fitted into a single 3 layered struct.
% 
% INPUTS:
% --------------------------------------------
%    ESCORT_mission - Struct defined in generate_ESCORT_mission function. 
%    Contains mission segment parameters and aircraft states 
% 
%    lift_to_drag_calc function - Function outputting double.
%    Used to calculate the L/D for cruise, dash and the max below 
%    which feeds into the ff calculations for corresponding mission segments.
...
% OUTPUTS:
% --------------------------------------------
%    mission_ff - Double. Fuel empty fraction calculated for ESCORT mission [unitless]
% 
% See also: generate_ESCORT_mission(), max_lift_to_drag(), TBU
% Author:                          Juan
